...
const About = () => {
  return (
    <section className="about">
      <h2>About Us</h2>
      <p>Welcome to our Recipe App. We provide delicious recipes for you to try at home.
          Heritage Heaven from South Africa is a web app made by Tionne,Thanyani and Arlincia in hopes that 
